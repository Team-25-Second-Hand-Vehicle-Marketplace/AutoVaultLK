/**
 * Extracted from ParseNotice.tsx so that file exports only its component.
 * react-refresh cannot hot-reload a module that mixes component and
 * non-component exports — an edit here would force a full page reload
 * and drop the search state being worked on.
 */
